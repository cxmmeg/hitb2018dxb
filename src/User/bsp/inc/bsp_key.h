...
/* 根据应用程序的功能重命名按键宏 */
#define KEY_DOWN_OK		KEY_1_DOWN
#define KEY_UP_OK		KEY_1_UP
#define KEY_LONG_OK		KEY_1_LONG

#define KEY_DOWN_ESC	KEY_2_DOWN
#define KEY_UP_ESC		KEY_2_UP
#define KEY_LONG_ESC	KEY_2_LONG

#define KEY_DOWN_S1		KEY_3_DOWN
#define KEY_UP_S1		KEY_3_UP
#define KEY_LONG_S1		KEY_3_LONG

#define KEY_DOWN_S2		KEY_4_DOWN		/* ok */
#define KEY_UP_S2		KEY_4_UP
#define KEY_LONG_S2		KEY_4_LONG
...
*/
#define KEY_FILTER_TIME   5				/* 单位10ms，连续50ms状态不变才有效 */
