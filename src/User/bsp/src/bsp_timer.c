...
*		V1.1    2013-06-21   增加us级延迟函数 bsp_DelayUS
*		V1.2    2014-09-07   增加TIM4 硬件定时中断，实现us级别定时.20us - 16秒
*		V1.3    2015-04-06   增加 bsp_CheckRunTime(int32_t _LastTime) 用来计算时间差值
*		V1.4	2015-05-22   完善 bsp_InitHardTimer() ，增加条件编译选择TIM2-5
*
...
uint32_t bsp_GetRunTimeUS(void)
{
	uint32_t ms;
	uint32_t cycle_cnt;
	uint32_t res;
